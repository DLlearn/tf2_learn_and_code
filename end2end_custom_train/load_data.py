...
def load_II(path, batch_size,train=False):
    ...
    heart_beat_files = tf.io.gfile.glob(heart_beat_path)
    gr_info_files = tf.io.gfile.glob(gr_info_path)
    rpos_info_files = tf.io.gfile.glob(rpos_info_path)
    rmask_info_files = tf.io.gfile.glob(rmask_info_path)
    rclass_info_files = tf.io.gfile.glob(rclass_info_path)
